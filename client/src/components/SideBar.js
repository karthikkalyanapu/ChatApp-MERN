...
const SideBar = () => {
    ...
    return (
        <div className='w-full h-full grid grid-cols-[48px,1fr]'>
            <div className='bg-slate-200 w-12 h-full rounded-tr-lg rounded-br-lg py-5 text-slate-800 flex flex-col justify-between'>
                <div>
                    ...
                    <NavLink title='add friend' onClick={() => setOpenSearchUser(true)} className='w-12 h-12 flex justify-center items-center cursor-pointer hover:bg-slate-300 rounded'>
                        <FaUserPlus size={25} />
                    </NavLink>
                </div>
                ...
                <div className='flex flex-col items-center'>
                    ...
                    <button onClick={handleLogout} className='w-12 h-12 flex justify-center items-center cursor-pointer hover:bg-slate-300 rounded' title='logout'>
            ...
            {
                openSearchUser && (
                    <SearchUsers onClose={() => setOpenSearchUser(false)} />
                )
            }
        </div>
    )
